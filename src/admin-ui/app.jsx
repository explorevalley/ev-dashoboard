...
const DASHBOARD_EXTRA_TABLES = Object.freeze({
  ...
  travel: [TABLES.BOOKINGS, TABLES.CAB_BOOKINGS, TABLES.BUS_BOOKINGS, TABLES.BIKE_BOOKINGS, TABLES.DRIVER_REG_REQUESTS, TABLES.DRIVERS, TABLES.DRIVER_VEHICLES, TABLES.DRIVER_BIDS, TABLES.RIDE_ASSIGNMENTS, TABLES.REFUNDS, TABLES.QUERIES, TABLES.TOURS, TABLES.HOTELS, TABLES.BUSES, TABLES.CAB_PROVIDERS, TABLES.TAXI_FARES, TABLES.REVIEWS],
